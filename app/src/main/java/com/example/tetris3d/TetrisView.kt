...
class TetrisView(context: Context) : View(context) {
    ...
    private val bgPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply { color = Color.parseColor("#0a0d1a") }
    private val gridPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply { color = Color.parseColor("#1a1e30") }
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        val totalHeight = h
        val spaceTop = (totalHeight - boardHeight) * 0.35f
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        canvas.drawText("TETRIS CANAÃ", w / 2f, boardOffsetY - dpToPx(12f), titlePaint)
    ...
    private fun calculateGhostY(): Int {
        ...
        while (true) {
            ...
            for (p in engine.currentShape) {
                ...
                val ny = gy + p.y
                if (ny >= 20 || ny < 0 || (ny in 0 until 20 && engine.grid[ny][nx] != 0)) return gy - 1
            }
        }
    }
